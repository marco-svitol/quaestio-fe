            ...
            <div className="min-w-[150px]">
                {
                    isLogged ? (
                        <div className="flex gap-4 items-center">
                            ...
                            <Link to="/settings"><div className="border border-red-300 py-1 pt-[10px] px-3 rounded-xl" onClick={() => handleSection(2)}><i className="fi fi-rr-user-gear text-2xl"></i></div></Link>
                        </div>
                    ) : (
                        <></>
                    )
